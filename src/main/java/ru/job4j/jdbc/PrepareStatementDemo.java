...
public class PrepareStatementDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        demo.insert(new City(1, "Petersburg", 1000));
        System.out.println(demo.inserts(new City(2, "NewPetersburg", 5000000)).toString());
        demo.update(new City(3, "OldPetersburg", 1000000));
        System.out.println(demo.findAll().toString());
        demo.delete(2);
        System.out.println(demo.findAll().toString());
    }
}